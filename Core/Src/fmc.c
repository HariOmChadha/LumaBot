...
void MX_FMC_Init(void)
{
  ...
  */
  ...
  /* USER CODE BEGIN FMC_Init 2 */
    ...
    HAL_Delay(1); // Wait 1ms for clock to stabilize
    ...
    // 4. Load Mode Register (CAS Latency 2, Burst Length 1)
    ...
    // 5. Set Refresh Rate for 100MHz clock
